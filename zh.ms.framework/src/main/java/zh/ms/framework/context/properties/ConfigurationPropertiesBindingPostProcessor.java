...
package zh.ms.framework.context.properties;
...
public class ConfigurationPropertiesBindingPostProcessor
    ...
    public void postProcessBeforeInitialization(Object bean, ConfigurationProperties annotation) {
        Object target = bean;
        ...
        try {
            ...
            throw new BeanCreationException(bean.getClass().getCanonicalName(), "Could not bind properties to "
