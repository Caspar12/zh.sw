...
define([
    ...
    return declare('admin/view-partial/main/order-delivery-plan/widget/form/value-widget/OrderDeliveryPlanNameTextBox', [TextBox], {
        label: OrderDeliveryPlanEnum.DeliveryPlanName.text,
        name: OrderDeliveryPlanEnum.DeliveryPlanName.id,
        placeHolder: OrderDeliveryPlanEnum.DeliveryPlanName.text,
    });
});