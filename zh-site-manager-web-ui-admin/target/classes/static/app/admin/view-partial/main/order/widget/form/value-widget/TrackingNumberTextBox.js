 ...
 * @date 2016/12/29
 * @file admin/view-partial/main/order/widget/form/value-widget/TrackingNumberTextBox
 */
define([
    ...
    return declare('admin/view-partial/main/order/widget/form/value-widget/TrackingNumberTextBox', [TextBox], {
